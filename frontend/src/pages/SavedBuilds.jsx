                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex flex-col items-end space-y-1">
                      {activeTab === 'trash' ? (
                        ...
                        <>
                          {cart.is_optimized && (
                            <span className={`text-[10px] font-bold px-2 py-1 rounded border uppercase ${isNgo ? 'bg-[#24b47e]/10 text-[#3ecf8e] border-[#24b47e]/20' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                              AI Optimized
                            </span>
                          )}
                          {cart.is_completed && (
